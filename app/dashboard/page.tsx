...
export default async function DashboardPage() {
  ...
  try {
    ...
    const lastMonthCount = enrollments.filter(e => e.createdAt >= lastMonthStart && e.createdAt < currentMonthStart).length;
      ...
      <div className="p-6 md:p-10 max-w-7xl mx-auto w-full">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-12 pb-10 border-b border-gray-100">
          <div>
            ...
            <p className="text-gray-500 mt-1 font-medium text-sm">Bienvenue, {user.firstName || 'Instructeur'}. Votre académie en un coup d'œil.</p>
          </div>
